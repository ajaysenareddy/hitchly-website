        ...
        <footer className="footer">
            <div className="container footer-content">
                ...
                <div className="footer-social">
                    <a
                        href="https://www.linkedin.com/company/hitchly/"
                        className="footer-social-link"
                        target="_blank"
                        rel="noopener"
                        aria-label="Hitchly on LinkedIn"
                        title="Hitchly on LinkedIn"
                    >
                    ...
                    <a
                        href="https://www.instagram.com/hitchlyapp/"
                        className="footer-social-link"
                        target="_blank"
                        rel="noopener"
                        aria-label="Hitchly on Instagram"
                        title="Hitchly on Instagram"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
