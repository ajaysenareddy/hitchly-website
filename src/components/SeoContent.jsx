            ...
            <div className="container">
                <div className="seo-header">
                    ...
                    <p className="seo-intro">
                        ...
                        more affordable way to travel. Whether you are heading to Hitech City, Gachibowli, Madhapur,
                ...
                <div className="seo-grid">
                    ...
                    <div className="seo-block">
                        <div className="seo-block-icon">
                            <Users size={28} />
                        </div>
                        <h3>Carpool With People Going the Same Way</h3>
                        <p>
                            Finding a reliable carpool partner in Hyderabad used to be a challenge. Not anymore.
                            Hitchly connects daily commuters traveling similar routes so you can share your office ride
                            with verified professionals from your area. Whether you are a driver with empty seats or a
                    ...
                    <div className="seo-block">
                        ...
                        <p>
                            ...
                            carpoolers report saving between Rs 2000 and Rs 5000 per month on commute costs alone.
                        </p>
                        <p>
